  ...
  return (
    <>
        ...
        >
          ...
          <span className="xl:inline-block hidden">Hi Search... </span>
        </button> 
        </div>
        */}
      ...
      <Transition show={isOpen} as={Fragment}>
       ...
       <div className="flex max-w-md mx-4 relative">
            <Textinput type="text" 
                className="block w-full pl-10 pr-3 py-2 border border-grey-300 rounded-lg bg-white placeholder-grey-500 focus:outline-none focus:ring-2 focus:ring-grey-500 focus:border-grey-500" 
                icon="heroicons-outline:search"
                placeholder="Search jobs, skills, events..."/>
        </div>
    </>
  );
};
